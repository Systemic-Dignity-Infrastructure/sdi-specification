...
WP_ROOT = 04_working_papers

WP1_DIR = $(WP_ROOT)/wp1_stewardship_model
WP1_SRC = ssrn-5968756_Revised

WP2_DIR = $(WP_ROOT)/wp2_surplus_capacity
WP2_SRC = ssrn-6211658_Revised

WP3_DIR = $(WP_ROOT)/wp3_los_angeles_pipeline
WP3_SRC = ssrn-6579600_Revised

WP4_DIR = $(WP_ROOT)/wp4_human_layer
