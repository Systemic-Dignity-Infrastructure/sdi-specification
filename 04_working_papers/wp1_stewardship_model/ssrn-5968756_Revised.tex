...
\textit{The MDI Tower figures reflect the 348-resident Singular Prototype basis established in \texttt{05\_reference\_models/CAPITAL.md}, inclusive of amortized capital debt service; see the Efficiency Surplus table above for the corresponding tower-level calculation at both prototype and full-build-out scale. This figure is provisional pending the Independent Financial Review specified in GOVERNANCE.md \S11.B.}
