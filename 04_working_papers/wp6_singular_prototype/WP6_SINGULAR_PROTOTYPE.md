# The Anatomy of the Singular Prototype: Scaling SDI to the Dunbar Baseline

**Series:** Material Dignity Infrastructure Working Paper 6 (Preliminary)
**Status:** Foundational Research Document — Pre-SSRN

---

## Abstract

The Singular Prototype represents the minimum viable deployment of the Systemic Dignity Infrastructure: a three-pod, 185,000-square-foot vertical tower housing 348 residents. This document derives the single-pod unit economics (85,000 square feet, 116 residents) from biological and operational first principles, establishes the multi-pod scaling economics that justify the three-pod standard, and introduces the mega-tower segregation model for large-scale commercial adaptive reuse.
...
While the 85,000 square foot figure and the 116 resident ceiling function as the absolute internal unit logic, the $36.9M, 185,000 square foot three-pod deployment operates as the non-negotiable minimum viable deployment (the Singular Prototype Threshold) for the overall network. The architecture refuses to scale below this baseline.

---

## Series Context

This document is the sixth working paper in the Material Dignity Infrastructure series:
...
- **WP6 (this document)**: The Anatomy of the Singular Prototype (Preliminary)
